return {
    ...
    keys = {
        ...
        { "<leader>fs",  function() Snacks.picker.grep({ search = vim.fn.input("Grep > "), live = false }) end, desc = "Grep string (input)" },
        -- git
        { "<leader>gm",  function() Snacks.picker.git_status() end,                                             desc = "Git Status/Modified" },
        -- gh
